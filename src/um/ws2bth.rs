...
use crate::shared::bthdef::{
    BTH_ADDR, MAX_L2CAP_INFO_DATA_LENGTH, MAX_L2CAP_PING_DATA_LENGTH, MAX_UUIDS_IN_QUERY,
};
use crate::shared::bthsdpdef::{SdpAttributeRange, SdpQueryUuid};
use winapi::shared::guiddef::GUID;
use winapi::shared::minwindef::{DWORD, PULONG, UCHAR, ULONG, USHORT};
use winapi::shared::ws2def::IOC_VENDOR;
